...
class Portal(pg.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = pg.transform.scale(
            self.image, (TAMAÑO_TILE_CARPETA, TAMAÑO_TILE_CARPETA))
        self.x = x
        self.y = y
...
class PlataformaCentro(Plataforma):
    def __init__(self, game, x, y):
        Plataforma.__init__(self, game, x, y)
        self.image = self.game.spritesheet.get_imagen(0, 330, 64, 64)
        self.type = "normal"


class PlataformaExtremoI(Plataforma):
    def __init__(self, game, x, y):
        Plataforma.__init__(self, game, x, y)
...
class PlataformaExtremoD(Plataforma):
    def __init__(self, game, x, y):
        Plataforma.__init__(self, game, x, y)
...
class PlataformaTrampaCentro(Plataforma):
    def __init__(self, game, x, y):
        Plataforma.__init__(self, game, x, y)
...
class PlataformaTrampaI(Plataforma):
    def __init__(self, game, x, y):
        Plataforma.__init__(self, game, x, y)
...
class PlataformaTrampaD(Plataforma):
    def __init__(self, game, x, y):
        Plataforma.__init__(self, game, x, y)
